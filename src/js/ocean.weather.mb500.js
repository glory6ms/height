...
export var MB500Layer = CanvasLayer.extend({
  ...
  options:{
    ...
    showLevel: 4, // 文字的显示级别
    stroke: true,
    color:  '#f01400',// '#61A5E8', '#00ff00', '#0000ff'
    weight: 0.8,
    opacity: 0.5,
    fillOpacity: 0.2,
    lineCap: 'round',
  ...
  _drawLine: function (ctx, points, text) {
    // console.log(points)
    var p ;
    ctx.save();
    ctx.beginPath();
  ...
  _fillStroke: function (ctx, text) {
		var options = this.options;

    var colors=['#ff1500', '#660099', '#cc0033','#ffaa00','#096'];
